...
class QuantileForest:
    def __init__(self, quantiles=0.5, nthreads=1, min_samples_split=10, n_estimators=100):
        self.quantiles = quantiles
        self.model = QuantileRandomForestRegressor(nthreads=nthreads, min_samples_split=min_samples_split,
...
class QuantileRandomForestRegressor:
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        self.trainy = y.copy()
        self.trainX = X.copy()
        print('Forest QR training finished.')
